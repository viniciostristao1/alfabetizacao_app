...
enum Tema {
  casa('casa', 'Casa', '🏠', Color(0xFF5B9CFF)),
  museu('museu', 'Museu', '🏛️', Color(0xFFB98BFF)),
  escola('escola', 'Escola', '🏫', Color(0xFFFF8A5B)),
  cafeteria('cafeteria', 'Cafeteria', '☕', Color(0xFFF5A524)),
  bombeiros('bombeiros', 'Bombeiros', '🚒', Color(0xFFFF6B6B));

  const Tema(this.chave, this.rotulo, this.emoji, this.cor);
