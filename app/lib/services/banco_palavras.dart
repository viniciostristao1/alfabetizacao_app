...
const List<Palavra> bancoPalavras = [
  ...
  // Foto `alimentos_temas_foto.png` (1376×768) com mercado/ri o/plantação.
  // 5 temas com faixas invisíveis na foto. Cada um tem 12+ palavras.
  // 🏪 Mercado
  Palavra(['lin','gui','ça'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['pas','tel'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['co','xi','nha'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['a','ça','í'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['fa','ro','fa'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['ra','pa','du','ra'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['pa','ço','ca'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['qui','be'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['es','fir','ra'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['em','pa','da'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['pa','mo','nha'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['can','ji','ca'], Categoria.alimentos, tema: 'mercado'),
  // 🍎 Pomar
  Palavra(['ca','qui'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['li','mão'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['ma','mão'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['ja','bu','ti','ca','ba'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['a','ce','ro','la'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['ca','ju'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['pi','tan','ga'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['jam','bo'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['se','ri','gue','la'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['ca','já'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['gra','vi','o','la'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['cu','pu','a','çu'], Categoria.alimentos, tema: 'pomar'),
  // 🥬 Horta
  Palavra(['al','fa','ce'], Categoria.alimentos, tema: 'horta'),
  Palavra(['cou','ve'], Categoria.alimentos, tema: 'horta'),
  Palavra(['rú','cu','la'], Categoria.alimentos, tema: 'horta'),
  ...
  Palavra(['es','pi','na','fre'], Categoria.alimentos, tema: 'horta'),
  Palavra(['sal','sa'], Categoria.alimentos, tema: 'horta'),
  Palavra(['ce','bo','li','nha'], Categoria.alimentos, tema: 'horta'),
  Palavra(['co','en','tro'], Categoria.alimentos, tema: 'horta'),
  Palavra(['na','bo'], Categoria.alimentos, tema: 'horta'),
  Palavra(['ra','ba','ne','te'], Categoria.alimentos, tema: 'horta'),
  // 🌾 Roça
  ...
  Palavra(['al','go','dão'], Categoria.alimentos, tema: 'roca'),
  Palavra(['a','vei','a'], Categoria.alimentos, tema: 'roca'),
  Palavra(['ce','va','da'], Categoria.alimentos, tema: 'roca'),
  Palavra(['cen','tei','o'], Categoria.alimentos, tema: 'roca'),
  Palavra(['sor','go'], Categoria.alimentos, tema: 'roca'),
  Palavra(['gi','ras','sol'], Categoria.alimentos, tema: 'roca'),
  Palavra(['len','ti','lha'], Categoria.alimentos, tema: 'roca'),
  Palavra(['er','vi','lha'], Categoria.alimentos, tema: 'roca'),
  Palavra(['ger','ge','lim'], Categoria.alimentos, tema: 'roca'),
  // 🍚 Arrozal / Rio
  ...
  Palavra(['ma','ris','co'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['la','gos','ta'], Categoria.alimentos, tema: 'arrozal'),
