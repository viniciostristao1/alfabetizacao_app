...
const List<Palavra> bancoPalavras = [
  ...
  // ───────────────────── TEMAS (ALIMENTOS — FAZENDA) ─────────────────────
  // Foto `alimentos_temas_foto.png` (1376×768) com mercado/rio/plantação.
  // 5 temas com 12 palavras familiares (rotina da criança) — ordenadas por
  // dificuldade (letras→sílabas) então as mais curtas/conhecidas vêm primeiro.
  // 🏪 Mercado — compras da rotina
  Palavra(['bo','lo'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['quei','jo'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['lei','te'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['car','ne'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['o','vo'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['su','co'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['ca','fé'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['bis','coi','to'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['bo','la','cha'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['sal','si','cha'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['pre','sun','to'], Categoria.alimentos, tema: 'mercado'),
  Palavra(['man','tei','ga'], Categoria.alimentos, tema: 'mercado'),
  // 🍎 Pomar — frutas da rotina
  Palavra(['ma','çã'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['pe','ra'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['u','va'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['ba','na','na'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['la','ran','ja'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['man','ga'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['li','mão'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['ma','mão'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['me','lão'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['a','ba','ca','te'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['a','ba','ca','xi'], Categoria.alimentos, tema: 'pomar'),
  Palavra(['mo','ran','go'], Categoria.alimentos, tema: 'pomar'),
  // 🥬 Horta — verduras da rotina
  Palavra(['cou','ve'], Categoria.alimentos, tema: 'horta'),
  Palavra(['al','fa','ce'], Categoria.alimentos, tema: 'horta'),
  Palavra(['to','ma','te'], Categoria.alimentos, tema: 'horta'),
  Palavra(['ce','nou','ra'], Categoria.alimentos, tema: 'horta'),
  Palavra(['ba','ta','ta'], Categoria.alimentos, tema: 'horta'),
  Palavra(['ce','bo','la'], Categoria.alimentos, tema: 'horta'),
  Palavra(['pe','pi','no'], Categoria.alimentos, tema: 'horta'),
  Palavra(['re','po','lho'], Categoria.alimentos, tema: 'horta'),
  Palavra(['be','ter','ra','ba'], Categoria.alimentos, tema: 'horta'),
  Palavra(['pi','men','tão'], Categoria.alimentos, tema: 'horta'),
  Palavra(['bró','co','lis'], Categoria.alimentos, tema: 'horta'),
  Palavra(['a','bó','bo','ra'], Categoria.alimentos, tema: 'horta'),
  // 🌾 Roça — grãos da rotina
  Palavra(['ar','roz'], Categoria.alimentos, tema: 'roca'),
  Palavra(['fei','jão'], Categoria.alimentos, tema: 'roca'),
  Palavra(['mi','lho'], Categoria.alimentos, tema: 'roca'),
  Palavra(['tri','go'], Categoria.alimentos, tema: 'roca'),
  Palavra(['so','ja'], Categoria.alimentos, tema: 'roca'),
  Palavra(['ca','na'], Categoria.alimentos, tema: 'roca'),
  Palavra(['a','vei','a'], Categoria.alimentos, tema: 'roca'),
  Palavra(['man','di','o','ca'], Categoria.alimentos, tema: 'roca'),
  Palavra(['a','men','do','im'], Categoria.alimentos, tema: 'roca'),
  Palavra(['pi','po','ca'], Categoria.alimentos, tema: 'roca'),
  Palavra(['fa','ri','nha'], Categoria.alimentos, tema: 'roca'),
  Palavra(['a','çú','car'], Categoria.alimentos, tema: 'roca'),
  // 🍚 Arrozal / Rio — peixes e frutos do rio (rotina)
  Palavra(['pei','xe'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['si','ri'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['os','tra'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['lu','la'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['pol','vo'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['a','tum'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['ca','ma','rão'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['sar','di','nha'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['ti','lá','pia'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['dou','ra','do'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['pes','ca','da'], Categoria.alimentos, tema: 'arrozal'),
  Palavra(['ca','ran','gue','jo'], Categoria.alimentos, tema: 'arrozal'),
];
