...
const List<Livro> bancoHistorinhas = [
  Livro(
    ...
    paginas: [
      ...
      'Na manhã seguinte acordaram felizes. Tomaram leite juntos na cozinha. O gato prometeu cuidar do rato. O rato prometeu não sumir. E viveram amigos para sempre.',
    ],
  ),
  Livro(
    chave: 'pato_lagoa',
    ...
    paginas: [
      ...
      'Na margem a família se reuniu. Todos os patinhos se abraçaram. A mamãe contou que a chuva faz bem. Depois todos secaram as penas ao sol. E viveram felizes na lagoa.',
    ],
  ),
  Livro(
    chave: 'sapo_feliz',
    ...
    paginas: [
      ...
      'Então todos cantaram juntos. O sapo, a tartaruga e os peixes. O rio ficou cheio de música alegre. Cantaram até o sol se pôr. E o céu ficou alaranjado.',
      'Quando a noite chegou, fizeram silêncio. A lua refletiu na água calma. O sapo guardou a flor na folha. Todos se despediram com carinho. E dormiram felizes ao som do rio.',
      'No outro dia o sapo acordou cantando. A tartaruga trouxe outra flor para ele. Eles prometeram cuidar do rio juntos. E cantaram uma nova canção. Fim.',
    ],
  ),
  Livro(
    chave: 'casa_vovo',
    ...
    paginas: [
      ...
      'Depois vovó contou uma história. Era sobre um castelo encantado e um dragão. Davi ouviu com os olhos brilhando. Abraçou a vovó com força. E sorriu de orelha a orelha.',
      'A tarde terminou com um abraço. Vovó deu um beijo na testa de Davi. Ele prometeu voltar no fim de semana. Levou um pedaço de bolo para casa. E dormiu feliz lembrando do dia.',
    ],
  ),
  Livro(
    chave: 'sol_lua',
    ...
    paginas: [
      ...
      'E assim o dia e a noite se abraçam. O Sol acorda sorrindo toda manhã. A Lua canta baixinho toda noite. As crianças agradecem aos dois. E dormem em paz sob o céu.',
    ],
  ),
  Livro(
    chave: 'tesouro_davi',
    ...
    paginas: [
      ...
      'Com os lápis ele desenhou um arco-íris. Usou todas as cores mais lindas. Mostrou para a mamãe e o papai. Eles colaram na geladeira com orgulho. E todos bateram palmas.',
      'Davi guardou o mapa com carinho. Colocou junto com seus desenhos. Prometeu fazer um novo mapa amanhã. Para esconder outro tesouro no quintal. E viveu muitas aventuras depois.',
      'E desde então Davi virou explorador. Todo dia inventa um novo tesouro. Chama os amigos para procurar. O quintal virou um mundo mágico. Fim.',
    ],
  ),
  Livro(
    ...
    paginas: [
      ...
      'Acharam a cenoura bem escondida. Estava atrás das abóboras grandes. Era tão grande que precisaram de ajuda. Levaram juntos para a clareira. E todos ficaram admirados.',
      'O coelho dividiu a cenoura com todos. Cada amigo ganhou um pedaço crocante. Fizeram uma festa linda na horta. Com suco e dança na grama. E agradeceram ao sol.',
      'No final todos deram as mãos. Prometeram cuidar da horta juntos. O coelho agradeceu com um pulinho. E plantou novas sementes no chão. Para ter mais cenouras amanhã.',
    ],
  ),
  Livro(
    chave: 'aviao_azul',
    ...
    paginas: [
      ...
      'O avião pousou com cuidado na neve. Todos desceram bem devagarinho. Brincaram na neve fofa e gelada. Fizeram um boneco de neve bem grande. E riram muito com o nariz de cenoura.',
      'Depois tomaram chocolate quente. O chocolate aqueceu as mãos geladas. As crianças deram tchau para a montanha. Entraram de volta no avião azul. E acenaram para o boneco de neve.',
      'O avião decolou de volta para casa. Voou sobre as nuvens cor de rosa. As crianças olharam o pôr do sol da janela. Chegaram em casa com boas lembranças. E sonharam com a neve à noite.',
      'No outro dia contaram a aventura na escola. Mostraram fotos do boneco de neve. Todos quiseram voar no avião azul também. O piloto prometeu levar todos de novo. Fim.',
    ],
  ),
];
