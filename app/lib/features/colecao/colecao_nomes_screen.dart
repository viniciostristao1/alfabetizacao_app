...
class ColecaoNomesScreen extends StatefulWidget {
  const ColecaoNomesScreen({super.key});

  @override
  State<ColecaoNomesScreen> createState() => _ColecaoNomesScreenState();
}

class _ColecaoNomesScreenState extends State<ColecaoNomesScreen> {
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Complete as fases de Nomes para ganhar prêmios especiais!',
