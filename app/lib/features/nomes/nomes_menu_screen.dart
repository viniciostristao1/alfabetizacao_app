...
import '../selecao/selecao_nomes_screen.dart';
...
class _NomesMenuScreenState extends State<NomesMenuScreen> {
  ...
  Future<void> _selecionarNomes() async {
    final escolhidos = await Navigator.of(context).push<List<Palavra>>(
      MaterialPageRoute(builder: (_) => const SelecaoNomesScreen()),
    );
            ...
            child: Align(
              ...
              child: Padding(
                ...
                child: _BotaoTransparente(
                  icon: Icons.search,
                  texto: 'SELECIONAR NOMES',
                  onTap: _selecionarNomes,
                ),
              ),
            ),
          ),
